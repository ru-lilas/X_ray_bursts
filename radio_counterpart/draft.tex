...
\begin{equation}
  \dv{N}{\gamma} = C\gamma^{-p}\quad(\gamma_\mathrm{min} < \gamma < \gamma_\mathrm{max})
\end{equation}
...
\begin{empheq}{align}
  ...
  &\approx
  m_\mathrm{e}c^2 \frac{C}{p-2} \gamma_{\mathrm{min}}^{2-p}
