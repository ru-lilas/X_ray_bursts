...
\begin{equation}
  ...
  N(\gamma) = N_0\gamma^{-p}\quad(\gamma_\mathrm{min} < \gamma < \gamma_\mathrm{max})
\end{equation}
...
\begin{empheq}{align}
  P_\nu
  &=
  \frac{2\sqrt{3}}{7} N_0 c^{3/4} e^{7/4}
  \left( \frac{3}{2\pi me_e c^2} \right)^{3/4}
  \Gamma\left( \frac{3p+19}{12} \right)
  \Gamma\left( \frac{3p-1}{12} \right)
  B^{7/4}
  \nu^{-3/4}\\
  ...
  {B_{28}}^{7/4}~
  {\nu_{100}}^{-3/4}~
  % \left( \frac{B}{\SI{28}{G}} \right)^{7/4}
  \left( \frac{N_0}{\SI{1.1e9}{cm^{-3}}} \right)
  % \left( \frac{\nu}{\SI{10}{GHz}} \right)^{-3/4}
\end{empheq}
観測されるflux~$F_\nu$は
\begin{empheq}{align}
  F_\nu 
